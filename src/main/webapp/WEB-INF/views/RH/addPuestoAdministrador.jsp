      ...
      <div class="panel panel-green">
        ...
        <div class="panel-body">
          <div class="dataTable_wrapper">
            <form:form action="recursoshumanosdep/uppuestoadmin" method="POST" commandName="Puesto">
                ${Resultado}
                <div class="form-group">
                  ...
                  <div class="form-group">  
                    <div class="row">
                      <div class="col-md-6">
                        <br/><label>Hora de Entrada</label>
                    ...
                    <div class="row">
                      <div class="col-md-6">
                        <br/><label>Rol del puesto</label>
                        <form:select class="form-control selectpicker show-tick show-menu-arrow listaPuesto" path="rol.id">                                                      
                            <form:option value="0" label="Seleccione uno" />
                            <form:options  items="${Rol}"   itemValue="id" itemLabel="nombre" />
                        </form:select>
                      </div>
                      <div class="col-md-6">
                        <br/><label>Suelo Base</label>
