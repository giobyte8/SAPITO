<%-- 
    Document   : succesfulModificarLineas
...
<html>
    <head>
        ...
        <meta http-equiv="Refresh" content="2;url=AdministrarLineasProduccion" />
        <title>SAPITO</title>
                                            ...
                                            <div class="panel-body">
                                                <div class="row">
                                                    <div class="col-lg-12 text-center"> 
                                                        ...
                                                        <h3>Linea Produccion modificada correctamente</h3>
                                                        <p>Redireccionando...</p>
                                                    </div>
                                                </div>
                                            </div>
