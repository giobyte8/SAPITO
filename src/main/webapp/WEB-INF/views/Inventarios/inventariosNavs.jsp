        ...
        <ul class="nav navbar-nav side-nav">
            ...
            <li>
                ...
                <ul id="demo1" class="collapse">
                    <li>
                        <a href="${pageContext.request.contextPath}/inventario/materiaPrima">Materia prima</a>
                    </li>
                    <li>
                        <a href="${pageContext.request.contextPath}/inventario/productoTerminado">Producto terminado</a>
                    </li>
                </ul>            
            </li>
            <li>
                ...
                <ul id="demo2" class="collapse">
                    ...
                    <li>
                        <a href="${pageContext.request.contextPath}/inventario/registrarProductoTerminado">Producto terminado</a>
                    </li>
                </ul>            
            </li>
            <li>
