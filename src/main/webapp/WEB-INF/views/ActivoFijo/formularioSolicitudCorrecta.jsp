...
<html>
    <head>
        <meta http-equiv="Refresh" content="2;url=gdaSolicitudCorrecta" />
                                            ...
                                            <div class="row">
                                                ...
                                                <form action="rSolicitud" method="post">                                                                 
                                                    <div class="form-group ">
                                                        ...
                                                        <input type="text" name="cantidad" class="form-control" required value="Producto1" readonly="readonly">
                                                    </div>
                                                    <div class="form-group">
                                                        <label class="control-label" >Cantidad</label>
                                                        <input type="text" pattern="[0-9]{2}" title="Únicamente números enteros" name="cantidad" class="form-control" required  placeholder="Escribe n&uacute;mero" value="2" readonly="readonly">
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
