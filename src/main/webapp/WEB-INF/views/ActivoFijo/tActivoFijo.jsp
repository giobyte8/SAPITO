                  ...
                  <div class="panel-body">
                    ...
                    <div class="panel panel-green">
                      ...
                      <div class="panel-body">
                        <div class="row">
                          <div class="col-lg-12 text-left"> 
                            <form action="gdaTraslado" method="post">                                                                 
                              ...
                              <div class="form-group ">
                                <label class="control-label" >Nuevo Propietario</label>
                              ...
                              <div class="hidden">
                                <input name="idHistorial" type="text" value="${historial.id}" />
                              </div>
                          </div>
                        </div>
                      </div>
                    ...
                    <div class="form-group text-right">
                      <a href="traslado" onclick="return confirm('¿Est&aacute; seguro de cancelar la operaci&oacute;n?');"><input type="button" class="btn btn-success" value="Cancelar"></a>
