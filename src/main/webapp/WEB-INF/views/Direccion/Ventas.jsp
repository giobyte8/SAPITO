                        ...
                        <ul class="nav" id="side-menu">                            
                            ...
                            <li>
                                ...
                                <ul class="nav nav-second-level">
                                    <li>
                                        <a href="GenerarReporteVentas">Generar Reporte<span class="fa arrow"></span></a>
                                    </li>
                                    <li>
                                        <a href="AbriReporteHoyVentas">Abrir Reporte de Hoy<span class="fa arrow"></span></a>
                                    </li>
                                    <li>
                                        <a href="ConsultarReporteFechaVentas">Consultar Reporte por Fecha<span class="fa arrow"></span></a>
                                    </li>
                                    <li>
