                        ...
                        <ul class="nav" id="side-menu">                            
                            ...
                            <li>
                                ...
                                <ul class="nav nav-second-level">
                                    <li>
                                        <a href="GenerarReporteRH">Generar Reporte<span class="fa arrow"></span></a>
                                    </li>
                                    <li>
                                        <a href="AbriReporteHoyRH">Abrir Reporte de Hoy<span class="fa arrow"></span></a>
                                    </li>
                                    <li>
                                        <a href="ConsultarReporteFechaRH">Consultar Reporte por Fecha<span class="fa arrow"></span></a>
                                    </li>
                                    <li>
