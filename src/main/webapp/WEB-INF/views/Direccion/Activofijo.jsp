                        ...
                        <ul class="nav" id="side-menu">                            
                            ...
                            <li>
                                ...
                                <ul class="nav nav-second-level">
                                    <li>
                                        <a href="GenerarReporteActivofijo">Generar Reporte<span class="fa arrow"></span></a>
                                    </li>
                                    <li>
                                        <a href="AbriReporteHoyActivofijo">Abrir Reporte de Hoy<span class="fa arrow"></span></a>
                                    </li>
                                    <li>
                                        <a href="ConsultarReporteFechaActivofijo">Consultar Reporte por Fecha<span class="fa arrow"></span></a>
                                    </li>
                                    <li>
