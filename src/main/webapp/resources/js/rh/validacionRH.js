...
function confirmarConsultas(){
    var opt=confirm("Se elimina la consulta realizada\n\
                     ¿Esta seguro de realizar esta operación?");
    if (opt===true) {
...
function confirmModificaciones(){
     ...
     var opt=confirm("Se modificara los datos del Usuario\n\
                      ¿Esta seguro de realizar esta operación?");
    if (opt===true) {
        alert("Operación Realizada Exitosamente");
    }else{
...
function confirmBorrado(){
     var opt=confirm("Se eliminara un Usuario \n\
                     ¿Esta seguro de realizar esta operación?");
    if (opt===true) {
        alert("Operación Realizada Exitosamente");
    }else{
...
function confirmCancelar(){
    var opt=confirm("Se cancelara ¿Cancelar OperaciÃ³n?");
     if (opt===true) {
        alert("Operación Realizada Exitosamente");
    }else{
        return false;
